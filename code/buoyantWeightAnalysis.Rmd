...
***
Because the wilds and frags started with wildly different amounts of skeleton we want to calculate rate of change to try and normalize the data, but to also investigate which treatment is producing more skeleton. 
...
bwChange <- dplyr::left_join(bwChangeMelt1, bwChangeMelt2, by = c("geno", "species", "ID")) %>% 
