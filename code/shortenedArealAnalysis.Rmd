...
```
#Here we are creating a percent change figure for just D. lab
...
```
#Here we are creating a surface area change figure for just D. lab
...
```
#Here we are creating a surface area percent change figure for just P. cli
...
```
#Here we are creating a surface area change figure for just P. cli
...
```
#Here we are importing data for P. str
...
```
#Here we are creating a surface area percent change graph for just P. str
...
```
#Here we are creating a surface area change graph for just P. str
...
```
#Here we are showing a different method of combining all of the surface area percent change figures (grouped by species)
