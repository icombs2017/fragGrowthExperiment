...
saChange <- dcast(saFinal, id+treatment~timepoint) 


saChange <- dplyr::rename(saChange, "initialSurfaceArea" = "T0", "finalSurfaceArea" = "T6")
saChange
saChange$difference <- (saChange$finalSurfaceArea-saChange$initialSurfaceArea)
